package org.oscarrecinos.project;

import jakarta.persistence.EntityManager;
import jakarta.persistence.criteria.*;
import org.oscarrecinos.project.entity.Cliente;
import org.oscarrecinos.project.util.JpaUtil;
...
public class HibernateCriteria {
    public static void main(String[] args) {
        ...
        clientes = em.createQuery(query).setParameter("nombre", "Oscar").getResultList();
        clientes.forEach(System.out::println);
        ...
        clientes = em.createQuery(query).setParameter("nombreParam", "%el%")
                .getResultList();
        clientes.forEach(System.out::println);
